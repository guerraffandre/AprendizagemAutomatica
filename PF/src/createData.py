...
def ReadJson():
    with open("D:/tudo/Mestrado/IAA/Final/AprendizagemAutomatica/PF/data.txt", 'r') as file:
        json_str = file.read()
        return jsonpickle.decode(json_str)
        
def CreateJson(list):
    with open("D:/tudo/Mestrado/IAA/Final/AprendizagemAutomatica/PF/data.txt", "w") as file:
